...
// DEPRECATED: Legacy circular AIModelCard retained for reference.
// Replaced by rectangular BadgeCard (components/ui/agent-badge-card.tsx) in AgentsTab.
// Safe to delete after design sign-off.
